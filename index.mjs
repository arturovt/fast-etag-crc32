...
if (typeof require === 'function') {
  ...
  binding = load(import.meta.dirname, () => ({
    'linux-x64': () =>
      require('./prebuilds/linux-x64+ia32/fast-etag-crc32.node'),
    'darwin-x64': () =>
      require('./prebuilds/darwin-x64+arm64/fast-etag-crc32.node'),
    'win32-x64': () =>
      require('./prebuilds/win32-x64+ia32/fast-etag-crc32.node'),
  }));
}

const etag = binding.etag;
const weakEtag = binding.weakEtag;

export { etag, weakEtag };
