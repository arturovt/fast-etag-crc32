...
const binding = typeof __dirname !== 'undefined' ? loadDefaultBinding(__dirname) : null;

module.exports = { etag: binding?.etag, weakEtag: binding?.weakEtag, loadViteBinding, loadDefaultBinding };
